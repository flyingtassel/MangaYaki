...
(function(window, jQuery) {
	...
	_unsafeWindow.MangaYaki.version = "0.8.1.20160108";
	...
	var MyApp = function(settings) {
		$(
			'<div id="mmOutputList"><div id="mmOutputList-selection">S</div><div id="mmOutputList-close">╳</div><div id="mmOutputList-clientArea"></div></div><div id="mmSidePanel" class="xxPanel"></div><div id="mmInfoPanel" class="xxPanel"><div id="mmComicName"></div><div id="mmVolumeNavigation"></div></div><div id="mmControlPanel" class="xxPanel"><div id="mmControlPanel-Message"><span class="mmImageStatus"></span><span class="mmPageNum"></span></div><div id="mmTools"><a href="#" class="xxButton menu-Advanced" title="更多功能"><span>更多...</span></a><div id="mmMenuAdvanced" class="xxMenu"><div><a href="#" class="xxButton tool-Settings-Global" title=""><span>設定通用選項</span></a></div><div><a href="#" class="xxButton tool-Settings-Local" title=""><span>設定個別網站</span></a></div><div><a href="#" class="xxButton tool-List" title=""><span>輸出圖片列表</span></a></div><div><a href="#" class="xxButton tool-Cache" title=""><span>檢視圖片預载</span></a></div><div><a href="#" class="xxButton view-TurboMode" title=""><span>切換覆蓋模式</span></a></div><div><a href="#" class="xxButton view-AutoSplit" title=""><span>切換自動分页</span></a></div></div></div><div id="mmPageNavigation"><a href="#" class="xxButton page-First" title="第一页"><span> |< </span></a><a href="#" class="xxButton page-Prev" title="上一页"><span> < </span></a><select class="page-Number"></select><a href="#" class="xxButton page-Next" title="下一页"><span> > </span></a><a href="#" class="xxButton page-Last" title="最後一页"><span> >| </span></a></div><div id="mmPageDisplay"><div id="mmFitRadio" class="xxRadioGroup"><a href="#" class="xxRadio fit-IntrinsicSize" title="實際大小"><span>I</span></a><a href="#" class="xxRadio fit-BestSize" title="最適大小"><span>B</span></a><a href="#" class="xxRadio fit-Width" title="符合寬度"><span>W</span></a><a href="#" class="xxRadio fit-Height" title="符合高度"><span>H</span></a><a href="#" class="xxRadio fit-Custom" title="自訂大小"><span>C</span></a><div id="mmMenuCustomMode" class="xxMenu"><div id="mmCustomRadio" class="xxRadioGroup"><div><a href="#" class="xxRadio custom-MaxWidth" title=""><span>最大寬度</span></a> <span><input class="txtCustom-MaxWidth" size="5" /></span></div><div><a href="#" class="xxRadio custom-MaxHeight" title=""><span>最大高度</span></a> <span><input class="txtCustom-MaxHeight" size="5" /></span></div><div><a href="#" class="xxRadio custom-FixedSize" title=""><span>固定大小</span></a> <span>寬: <input class="txtCustom-FixedSize-Width" size="5"/></span> <span>高: <input class="txtCustom-FixedSize-Height" size="5" /></span></div><div><a href="#" class="xxRadio custom-Zoom" title=""><span>縮放大小</span></a> <span><input class="txtCustom-Zoom" size="5" /> %</span></div></div></div></div></div></div>'
		).appendTo(document.body);
	...
	if (/^http:\/\/\w+.dmzj.com\//.test(gBaseUrl)) {
		var $oldImg = $("#TheImg");

		if ($oldImg.length) {

			document.oncontextmenu = function() {};
			var tp = document.getElementById("pic").src
			var pp = document.getElementsByClassName("pre")[0].firstChild.href
			var np = document.getElementsByClassName("next")[0].firstChild.href
			var $newImg = $("<img id='pic' />").insertAfter($oldImg);
